...
/**
 * Round intro and result screens for Chaos-Kommando.
 *
...
function renderIntro(scene: Phaser.Scene, state: RoundScreenState): void {
  ...
  addText(
    ...
    chaosKommandoManifest.displayName,
    {
...
function renderResult(scene: Phaser.Scene, state: RoundScreenState): void {
  ...
  addText(scene, layer, panelX, 122, state.message ?? chaosKommandoManifest.displayName, {
    fontFamily: theme.bodyFont,
    fontSize: "20px",
    color: theme.muted,
